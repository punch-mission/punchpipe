...
from punchpipe.simpunch.level1 import generate_spacecraft_wcs
...
if __name__ == "__main__":
    ...
    corrected_psf = gen_projected_psf_from_image(
            wcs_stellar_input, psf_width=psf_size, star_gaussian_sigma=target_sigma)
    forward_corrector = ArrayPSFTransform.construct(synthetic, corrected_psf, alpha=3.0, epsilon=0.9)
